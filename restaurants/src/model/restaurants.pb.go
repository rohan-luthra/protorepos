...
type Timings struct {
	Day                  Days     `protobuf:"varint,1,opt,name=day,proto3,enum=Days" json:"day,omitempty"`
...
type Restaurant struct {
	...
	PaymentMode          []PaymentModes   `protobuf:"varint,14,rep,packed,name=payment_mode,json=paymentMode,proto3,enum=PaymentModes" json:"payment_mode,omitempty"`
	Timings              []*Timings       `protobuf:"bytes,15,rep,name=timings,proto3" json:"timings,omitempty"`
	SubscriptionPlan     SubscriptionPlan `protobuf:"varint,16,opt,name=subscription_plan,json=subscriptionPlan,proto3,enum=SubscriptionPlan" json:"subscription_plan,omitempty"`
	DefaultCurrenyId     string           `protobuf:"bytes,17,opt,name=default_curreny_id,json=defaultCurrenyId,proto3" json:"default_curreny_id,omitempty"`
	AssignedSalesEmpId   string           `protobuf:"bytes,18,opt,name=assigned_sales_emp_id,json=assignedSalesEmpId,proto3" json:"assigned_sales_emp_id,omitempty"`
	AssignedOpsEmpId     string           `protobuf:"bytes,19,opt,name=assigned_ops_emp_id,json=assignedOpsEmpId,proto3" json:"assigned_ops_emp_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func init() {
	proto.RegisterEnum("SubscriptionPlan", SubscriptionPlan_name, SubscriptionPlan_value)
	proto.RegisterEnum("PaymentModes", PaymentModes_name, PaymentModes_value)
	proto.RegisterEnum("Days", Days_name, Days_value)
	proto.RegisterType((*Currency)(nil), "Currency")
	proto.RegisterType((*Payment)(nil), "Payment")
	proto.RegisterType((*Slots)(nil), "Slots")
	proto.RegisterType((*Timings)(nil), "Timings")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*Restaurant)(nil), "Restaurant")
}

func init() { proto.RegisterFile("src/proto/restaurants.proto", fileDescriptor_d282ef766bb01f4c) }

var fileDescriptor_d282ef766bb01f4c = []byte{
	// 888 bytes of a gzipped FileDescriptorProto
	,
}
